...
class DDRMemory : public MemObject {
    private:
        ...
        uint64_t sysFreqMHz, memFreqMHz;
        ...
        inline uint64_t sysToMemCycle(uint64_t sysCycle) { return sysCycle*memFreqMHz/sysFreqMHz+1; }
        inline uint64_t memToSysCycle(uint64_t memCycle) { return (memCycle+1)*sysFreqMHz/memFreqMHz; }
        ...
        inline uint64_t matchingMemToSysCycle(uint64_t memCycle) {
            ...
            return (2*memCycle-1)*sysFreqMHz/memFreqMHz/2;
        }
